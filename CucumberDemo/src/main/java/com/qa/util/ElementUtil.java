 ...
 * @Description: Element utility file
 *
 */
...
public class ElementUtil extends DriverFactory{
	...
	public  String selectedElementClr = "rgb(85, 86, 87)";
	 ...
	 */
	public  List<WebElement> waitForElements(WebDriver driver, List<WebElement> elementList) {
		try {
	 ...
	 */
	public  WebElement highlightElement(WebElement elmt, WebDriver driver) throws InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
	 ...
	 * @return
	 */
	public  void Hiddenelements(WebDriver driver, WebElement element) {
	 ...
	 * @return
	 */
	public  void datePicker(String enterDate, WebDriver driver) throws ParseException {
